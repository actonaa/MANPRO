    ...
    <div className="lg:rounded-b-xl lg:bg-white mt-6 border border-gray-200 shadow-sm rounded-2xl">
      ...
      <div className="flex justify-end items-center gap-2 p-4 bg-white border-b border-gray-200 rounded-t-2xl">
        <button
          ...
          className="flex items-center gap-2 text-gray-700 border border-gray-300 bg-white hover:bg-gray-50 rounded-lg px-4 py-2 text-sm font-medium"
        >
        ...
        <Link
          to="/sdm-admin-tambah"
          className="flex items-center gap-2 text-white bg-[#0095E8] hover:bg-[#007ACC] rounded-lg px-4 py-2 text-sm font-medium"
        >
          ...
          data.map((item) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <p className="text-sm text-gray-500 font-medium">{item.nip}</p>
        ...
        <table className="w-full text-[13px] border-collapse text-center">
          ...
          <tbody>
            {data.map((item) => (
              ...
              >
                <td className="py-5 px-4 font-semibold text-[#333]">
                  {item.nip}
                </td>
                <td className="py-5 px-4">{item.nama}</td>
                <td className="py-5 px-4">{item.jabatan}</td>
                <td className="py-5 px-4">{item.dinas}</td>
                <td className="py-5 px-4">{item.periodeKerja}</td>

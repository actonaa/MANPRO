              ...
              <>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full border border-[#ddd] rounded-lg px-3 py-2 mt-1"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {/* Kotak 1: Baik / Rusak */}
                    <div className="border border-[#ddd] rounded-lg px-3 py-2 w-full">
                      <div className="flex flex-col gap-2">
                        {["Baik", "Rusak"].map((kondisi) => {
                          // logika disable dua arah
                          const isBaikDipilih =
                            formData.kondisi.includes("Baik");

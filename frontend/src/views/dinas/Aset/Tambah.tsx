    ...
    >
      ...
      >
        ...
        <div className="flex justify-center mb-6">
          <div className={`bg-blue-50 rounded-full p-4 transform transition-all duration-500 ${
        ...
        {/* Title */}
        <h2 className={`text-xl font-semibold text-gray-900 text-center mb-2 transition-all duration-300 delay-100 ${
        ...
        {/* Subtitle */}
        <p className={`text-sm text-gray-500 text-center mb-8 transition-all duration-300 delay-150 ${
          isClosing ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'
        }`}>
                  ...
                  <div className="border border-gray-300 rounded-lg px-3 py-2 w-full">
                    <div className="flex flex-col gap-2">
                      {["Baik", "Rusak"].map((kondisi) => {
                        const isBaikDipilih = formData.kondisi.includes("Baik");
                        const isRusakDipilih =
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              disabled={
                                (isBaikDipilih && kondisi !== "Baik") ||
                                (isRusakDipilih && kondisi === "Baik")
                              }

export default function RisikoResidual() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-5 justify-between w-full h-full">
      {/* Judul */}
      <div className="lg:items-start lg:text-left">
        <h2 className="text-lg font-semibold text-[#131313] mb-4 lg:text-[22px] lg:mb-0">
          Status Risiko Aktif
        </h2>
      </div>

      <div className="flex gap-10 md:flex-col md:items-center md:gap-6 md:mt-20 lg:flex-row lg:items-start lg:mt-10 lg:justify-between">
